...
def is_swap(player_score, opponent_score):
    ...
    if abs_diff_player == abs_diff_opponent:
        return True
    else:
        return False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        # If it's player 0 turn, get his score otherwise get player 1 score
        if player == 0:
            ...
            say = h(score0, score1)
        # Check if the Swine Swap rule is in action
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def give_previous():
        return previous_high, previous_score
    ...
    def say(score0, score1):
        ...
        previous_high, previous_score = give_previous()
        this_high = current_score - previous_score

        if this_high > previous_high:
            print(this_high, 'point(s)! That\'s the biggest gain yet for Player', who)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    n, highest_average_score, roll, new_high = 1, 0, 1, False
    while n <= 10:
        avg_roll_dice = make_averaged(roll_dice, num_samples)
        avg = avg_roll_dice(n, dice)
        if avg > highest_average_score:
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(score + bacon, opponent_score) and (score + bacon) < opponent_score:
        return 0
    elif bacon >= margin and not is_swap(opponent_score, score + bacon):
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
